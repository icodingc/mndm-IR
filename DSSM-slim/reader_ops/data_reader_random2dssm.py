...
file_name = '/home/zhangxs/data/In-shop-IR/profile/train.lst'
...
def data_iter():
    ...
    while True:
        ...
        for batch_idx in xrange(0,len(shuf_lists)):
            ...
            negs = np.random.choice(item_lsts,5)
            while cur_fg in negs:negs = np.random.choice(item_lsts,5)
