...
def get_names2feat(name_file,feat_file):
    ...
    return rst
query_name2feat = get_names2feat('./query_filename.npy','./query_feature_%s.npy'%cc)
gallery_name2feat = get_names2feat('./gallery_filename.npy','./gallery_feature_%s.npy'%cc)
