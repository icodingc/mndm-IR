...
tf.app.flags.DEFINE_string('output_directory', './tfrecord_train',
...
def _process_dataset(name, directory, num_shards):
  filenames=[]
  with open('./profile/gallery.lst','r') as f:
    for a in f:filenames.append(a.strip())
...
def main(unused_argv):
  ...
  _process_dataset('gallery', FLAGS.train_directory, FLAGS.train_shards)
